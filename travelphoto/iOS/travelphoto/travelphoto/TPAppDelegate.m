...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(showLogin:) name:TPShowLogin object:nil];

    
    
    if([TPUserInfo sharedInstance].loadEmail == nil){
        [[NSNotificationCenter defaultCenter] postNotificationName:TPShowLogin object:self];
    }
    
    
    NSUserDefaults* userDefaults = [NSUserDefaults standardUserDefaults];
    NSString* password = [userDefaults stringForKey: @"hoge"];
...
- (void)applicationDidBecomeActive:(UIApplication *)application
{
    ...
    [FBAppCall handleDidBecomeActiveWithSession:[TPFacebook sharedInstance].session];
...
- (void)changeSidePanelCenterController:(NSNotification *)notification{
   ...
   NSDictionary *userInfo = [notification userInfo];
    ...
    if([userInfo[@"CLASS"] isEqualToString:@"TPSettingController"]){
        
        QRootElement *root = [[QRootElement alloc] init];
        root.controllerName = @"TPSettingController";
        root.grouped = YES;
...
- (void)showLogin:(NSNotification *) notification{
    ...
    dispatch_once(&oncePredicate, ^{
        QRootElement *root = [[QRootElement alloc] init];
        root.controllerName = @"TPLoginController";
        root.grouped = YES;
    
        _tpLoginController = (TPLoginController * )[QuickDialogController controllerForRoot:root];
